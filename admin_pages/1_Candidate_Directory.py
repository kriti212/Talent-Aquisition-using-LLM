...
if not candidates_list:
    ...
    if st.session_state.active_candidate_id:
        ...
        if curr_cand:
            ...
            st.success(f"🎯 **Currently Selected:** **{name}** | You can view this candidate's details in pages **2 Interview Scoring** and **3 Resume Details**.")
        ...
        for cand in filtered_candidates:
            ...
            with st.container():
                ...
                if st.button(f"🔍 Select & View Candidate - {name}", key=f"btn_sel_{cand_id_str}", use_container_width=True):
                    ...
                    st.success(f"Selected {name}! Please go to **2 Interview Scoring** or **3 Resume Details** in the sidebar to review.")
