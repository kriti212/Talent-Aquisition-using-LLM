...
# =====================================================
st.set_page_config(
    page_title="Talent AI - Recruiter Dashboard",
    page_icon="📊",
    layout="wide",
...
if not candidates_list:
    ...
    st.markdown("""
    - **1 Candidate Directory**: Search applicants by name/skills, filter by roles/statuses, and select a candidate for evaluation.
    - **2 Interview Scoring**: View overall match scorecard, progress bars for sub-metrics (Accuracy, Depth, STAR flow, Clarity), read CoT reasons, listen to audio answers, edit recruiter notes, and download dynamic ReportLab PDF reports.
    - **3 Resume Viewer**: Examine structured education, projects, skills, and inspect the raw text extracted from the candidate's uploaded resume.
    """)
